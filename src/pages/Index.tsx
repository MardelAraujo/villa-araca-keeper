...
const Index = () => {
  ...
  return (
    <MainLayout title="Dashboard" subtitle="Visão geral da sua pousada">
      {/* Stats Grid */}
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <StatCard
          title="Reservas Hoje"
          value={dashboardStats.reservasHoje}
        ...
        <StatCard
          ...
          variant="success"
          description="Chegadas previstas"
        />
        <StatCard
